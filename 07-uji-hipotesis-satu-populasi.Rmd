...
```{r fig-perbandingan-z-jarak, echo=FALSE, warning=FALSE, message=FALSE, fig.align="center", fig.cap="Perbandingan Nilai Statistik Uji dan Titik Kritis (Kasus Jarak ke Kampus ITERA)"}
library(ggplot2)
x <- seq(-4, 4, length.out = 1000)
df <- data.frame(x = x, y = dnorm(x))
ggplot(df, aes(x, y)) +
