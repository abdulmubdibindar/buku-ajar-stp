...
data_uinril <- data_uinril[, c("biaya.dalam.sepekan")]
data_unila <- data_unila[, c("biaya.dalam.sepekan")]
...
boxplot(biaya.dalam.sepekan ~ Kampus,
  data = data_gabung,
...
head(data_itera[, c("biaya.dalam.sepekan", "Uang.Saku")], 10)
```

Tabel di atas menunjukkan pasangan nilai untuk setiap mahasiswa. Kolom pertama (`biaya.dalam.sepekan`) akan menjadi sumbu X, dan kolom kedua (`Uang.Saku`) menjadi sumbu Y. Setiap baris akan menjadi satu titik pada scatterplot.
...
plot(data_itera$biaya.dalam.sepekan, data_itera$Uang.Saku,
...
abline(lm(Uang.Saku ~ biaya.dalam.sepekan, data = data_itera),
...
ggplot(data_itera, aes(x = biaya.dalam.sepekan, y = Uang.Saku)) +
