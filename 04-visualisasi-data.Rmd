...
kable(
  tabel_moda_jk,
  col.names = c('Jenis Kelamin', 'Berjalan Kaki', 'Kendaraan Bermotor (menumpang)',
...
kable(
  ...
  caption = 'Statistik Deskriptif Biaya Perjalanan Mahasiswa ITERA',
  digits = 2
) %>%
  kable_styling(
    bootstrap_options = c('striped', 'hover', 'condensed'),
...
```{r , echo=FALSE, fig-hist-biaya-auto, fig.cap='Histogram biaya perjalanan (bin otomatis)', fig.align='center', out.width='75%'}
...
```{r , echo=FALSE, fig-hist-biaya-manual, fig.cap='Histogram biaya perjalanan (bin manual)', fig.align='center', out.width='75%'}
...
kable(
  head(tabel_freq, 6),
  col.names = c('Interval Biaya', 'Frekuensi'),
  caption = 'Tabel Frekuensi Biaya Perjalanan (6 Interval Pertama)'
) %>%
  kable_styling(
    bootstrap_options = c('striped', 'hover', 'condensed'),
    full_width = FALSE,
...
kable(
  ...
  caption = 'Contoh Data Biaya Perjalanan dan Jarak Tempuh (10 Observasi Pertama)',
  digits = 2
) %>%
  kable_styling(
    bootstrap_options = c('striped', 'hover', 'condensed'),
...
```{r fig-scatter-ggplot, echo=FALSE, message=FALSE, fig.cap='Scatterplot jarak tempuh vs biaya perjalanan', fig.align='center', out.width='75%'}
library(ggplot2)
