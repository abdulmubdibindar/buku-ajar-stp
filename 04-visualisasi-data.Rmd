...
tabel_moda_jk <- data_uinril |>
  ...
  pivot_wider(names_from = kendaraan.utama, values_from = Frekuensi, values_fill = 0)

# Format tabel
kbl(
  tabel_moda_jk,
  col.names = c(
    "Jenis Kelamin", "Berjalan Kaki", "Kendaraan Bermotor (menumpang)",
    "Mobil Pribadi", "Sepeda", "Sepeda Motor Pribadi", "Transportasi Online"
  ),
...
data_itera$biaya.dalam.sepekan <- data_itera$biaya.dalam.sepekan / 1000
...
ggplot(data_gabung, aes(x = Kampus_PT, y = biaya.dalam.sepekan, fill = Kampus_PT)) +
