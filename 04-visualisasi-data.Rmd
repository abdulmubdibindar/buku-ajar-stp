...
```{r , echo=FALSE, fig-hist-biaya-auto, fig.cap='Histogram biaya perjalanan (bin otomatis) dalam ribuan rupiah', fig.align='center', out.width='75%'}
...
```{r , echo=FALSE, fig-hist-biaya-manual, fig.cap='Histogram biaya perjalanan (bin manual) dalam ribuan rupiah', fig.align='center', out.width='75%'}
