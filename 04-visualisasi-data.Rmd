...
1.  Jelaskan prinsip dasar pemilihan jenis grafik berdasarkan tingkat pengukuran variabelnya! (STP-3.1)
2.  Apa fungsi Boxplot dalam analisis data eksploratif? (STP-3.2)
3.  Perhatikan diagram berikut (misalkan ada diagram batang). Apa kesimpulan yang dapat diambil? (STP-3.3)
