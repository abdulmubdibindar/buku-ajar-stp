...
output:
  ...
  bookdown::pdf_book:
    ...
    extra_dependencies: ["subfig", "float", "booktabs", "microtype", "longtable"]
bibliography: referensi.bib
biblio-title: "Referensi"
link-citations: true
geometry: ["paperwidth=15.5cm", "paperheight=23cm", "twoside", "inner=25mm", "outer=20mm", "top=25mm", "bottom=25mm"]
fontsize: 11pt
linestretch: 1.15
colorlinks: true
---
