...
### Studi Kasus: Ilustrasi Elemen Data Terstruktur {.unnumbered #kasus-elemen-data-terstruktur}
...
2. **Kasus-2:** nilai `Usia` dinyatakan dalam bentuk rentang usia seperti berikut:
    ...
    * 56: 56-65 tahun
    ...
    Dalam kasus, nilai `17` bukan lagi berarti "17 tahun", melainkan "17-25 tahun". Artinya nilai `17` ini bisa saja bernilai `17` atau `18` atau `19` atau `20` atau `21` atau `22` atau `23` atau `24` atau `25`.
...
Langkah-langkah tersebut dapat diilustrasikan dalam diagram alir yang ditampilkan dalam 
