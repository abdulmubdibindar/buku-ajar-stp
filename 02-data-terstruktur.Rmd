...
kbl(perbandingan, format = 'html', escape = FALSE, 
...
kbl(tabel_1_3, format = 'html', escape = FALSE, 
...
kbl(rancangan, format = 'html', escape = FALSE, 
...
kbl(metadata, format = 'html', escape = FALSE, 
...
kbl(metadata_2, format = 'html', escape = FALSE, 
      col.names = c('Variabel', 'Nama Panggilan', 'Tingkat Pengukuran', 'Satuan', 'Nilai yang mungkin'),
...
kbl(preview_data, format = 'html', align = 'c',
...
kbl(metadata_soal, format = 'html', escape = FALSE,
