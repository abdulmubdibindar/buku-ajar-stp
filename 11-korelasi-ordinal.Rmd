...
```{r tbl-ilustrasi-concordant-discordant, echo=FALSE, message=FALSE, warning=FALSE}
library(kableExtra)

img_conc <- ifelse(knitr::is_html_output(),
                   '<img src="images/ilustrasi-concordant.png" style="width:100%;" />',
                   '\\includegraphics[width=1\\linewidth]{images/ilustrasi-concordant.png}')
img_disc <- ifelse(knitr::is_html_output(),
                   '<img src="images/ilustrasi-discordant.png" style="width:100%;" />',
                   '\\includegraphics[width=1\\linewidth]{images/ilustrasi-discordant.png}')

df_img <- data.frame(
  '(a) Pasangan Concordant' = img_conc,
  '(b) Pasangan Discordant' = img_disc,
  check.names = FALSE
)

tbl_out <- kbl(df_img, 
    caption = 'Ilustrasi Pasangan Frekuensi Concordant dan Discordant',
    align = 'c',
    escape = FALSE) |>
  kable_styling(
    full_width = FALSE, 
...
Berdasarkan pada Gambar \@ref(fig:tbl-ilustrasi-concordant-discordant)(a) dan disesuaikan dengan Tabel \@ref(tab:tbl-crosstab-ordinal), maka nilai $C$ adalah sebagai berikut.
...
Berdasarkan pada Gambar \@ref(fig:tbl-ilustrasi-concordant-discordant)(b) dan disesuaikan dengan Tabel \@ref(tab:tbl-crosstab-ordinal), maka nilai $D$ adalah sebagai berikut.
...
df_perbandingan <- data.frame(
  ...
  '$\\tau_b$ Kendall' = c('Matriks korelasi dengan jumlah kasus ($n$) besar', 
