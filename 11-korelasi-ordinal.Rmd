...
Nilai koefisien Somersâ€™ D berada pada rentang 0 sampai dengan 1 sehingga dapat diinterpretasikan kekuatan asosiasinya, serta arah asosiasi dengan nilai positif ataupun negatif sebagaimana koefisien $\gamma$.
...
Dalam perhitungan koefisien d Sommer (Sommerâ€™s d) kita sudah melibatkan penentuan variabel dependen dan independen, atau variabel yang dipengaruhi dan memengaruhi.

Dalam kasus kita, yang paling masuk akal adalah mengatakan **â€œtingkat semester perkuliahan memengaruhi tingkat uang sakuâ€** ketimbang â€œtingkat uang saku memengaruhi tingkat semester perkuliahan.â€ Oleh karena itu, kita menganggap variabel independennya adalah Tingkat Semester Perkuliahan dan variabel dependennya Tingkat Uang Saku.
