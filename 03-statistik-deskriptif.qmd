...
metadata_kasus <- data.frame(
  ...
  Keterangan = c(
    ...
    linebreak("Jenis kendaraan yang digunakan\n1 = sepeda motor pribadi\n2 = mobil pribadi\n3 = layanan online\n4 = menumpang kawan\n5 = sepeda\n6 = berjalan kaki"),
    linebreak("Tingkat semester kuliah\n1 = Tahun pertama\n2 = Tahun kedua\n3 = Tahun ketiga\n4 = Tahun keempat\n5 = Swasta (mahasiswa tingkat akhir)"),
...
Selain persen (per 100), ada juga satuan 'permil' (per 1000) dengan simbol â€°, yang biasa digunakan pada perhitungan-perhitungan yang melibatkan bilangan yang sangat kecil.
:::
...
kbl(detail_kendaraan, longtable = TRUE,
  align = "c",
...
data_pajak <- data.frame(
  ...
  Perhitungan = c("12% - 11% = 1 poin persentase", "(12% - 11%) / 11% Ã— 100% = 9,09%"),
  Makna = c("Terkesan kenaikan kecil", "Kenaikan hampir 10% dari beban pajak awal")
)

kbl(data_pajak, longtable = TRUE,
  align = "c",
...
kbl(data_outlier, longtable = TRUE,
  align = "c",
...
perbandingan <- data.frame(
  ...
  Mean = c("67,5", "119,4"),
  Median = c("67,5", "67,5"),
  Selisih_Mean = c("â€”", "+51,9"),
  Selisih_Median = c("â€”", "0")
)

kbl(perbandingan,
  align = "c",
  caption = "Perbandingan Mean dan Median",
  col.names = c("Kondisi", "Mean", "Median", "Î” Mean", "Î” Median")
) %>%
  kable_styling(
    bootstrap_options = c("striped", "hover"),
    latex_options = if (knitr::is_latex_output()) "HOLD_position" else c("striped", "hover"),
...
kbl(modus_perjalanan, longtable = TRUE,
  align = "c",
...
hasil_iqv <- data.frame(
  Komponen = c("Jumlah kategori (k)", "Î£páµ¢Â²", "1 - Î£páµ¢Â²", "IQV"),
  Nilai = c("8", "0,231", "0,769", "0,879")
)

kbl(hasil_iqv, longtable = TRUE,
  align = "c",
...
kbl(data_var,
  ...
  col.names = c("Mahasiswa", "Biaya (X)", "Rata-rata (xÌ„)", "Selisih (X - xÌ„)", "Kuadrat (X - xÌ„)Â²")
) %>%
  kable_styling(
    bootstrap_options = c("striped", "hover"),
    latex_options = if (knitr::is_latex_output()) "HOLD_position" else c("striped", "hover"),
