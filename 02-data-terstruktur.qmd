...
[Kesalahan-1: Header Baris Bersarang]{.tajuksaya}

- **Data Tidak Rapi**
  
  ```{r bab-2-kesalahan-1, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-kesalahan-1-recreate.png")
  ```

- **Data Rapi**
  
  ```{r bab-2-perbaikan-1, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-perbaikan-1-recreate.png")
  ```

[Kesalahan-2: Struktur Kompleks]{.tajuksaya}

- **Data Tidak Rapi**
  
  ```{r bab-2-kesalahan-2, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-kesalahan-2-recreate.png")
  ```

- **Data Rapi**
  
  ```{r bab-2-perbaikan-2, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-perbaikan-2-recreate.png")
  ```

[Kesalahan-3: Format Tidak Konsisten]{.tajuksaya}

- **Data Tidak Rapi**
  
  ```{r bab-2-kesalahan-3, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-kesalahan-3-recreate.png")
  ```

- **Data Rapi**
  
  ```{r bab-2-perbaikan-3, echo=FALSE, out.width='60%', fig.align='center'}
knitr::include_graphics("images/bab-2-perbaikan-3-recreate.png")
  ```
...
knitr::include_graphics("images/bab-2-menentukan-tingpeng.png")
```
...
rancangan <- data.frame(
  ...
  `Nama Panggilan` = c("`kend`", "`jarak`", "`frek\\_jalan\\_sepekan`", "`biaya`"),
  `Penjelasan` = c(
...
metadata <- data.frame(
  ...
  `Nilai yang mungkin` = c("Sepeda motor, mobil, angkutan umum, dll", "0 - $\\infty$ km", "0 - 7", "0 - $\\infty$"),
  check.names = FALSE
)
...
metadata_2 <- data.frame(
  ...
  `Satuan` = c("Tidak ada", "km", "kali", "rupiah (Rp)"),
  `Nilai yang mungkin` = c("Sepeda motor, mobil, angkutan umum, dll", linebreak("0 - 5 km,\n5 - 10 km,\n10 - 15 km,\ndll"), "0 - 7", "0 - $\\infty$"),
  check.names = FALSE
)
