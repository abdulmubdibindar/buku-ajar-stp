...
```{r bab14-model-penuh-evaluasi}
# Membuat model regresi dengan seluruh variabel
model_mk_penuh <- lm(iku ~ jarak_taman + jarak_industri + vegetasi + zona, data = df_mk)
...
```{r bab14-model-stepwise-evaluasi}
# Melakukan seleksi stepwise
model_mk_stepwise <- step(model_mk_penuh, direction = "both", trace = 0)
