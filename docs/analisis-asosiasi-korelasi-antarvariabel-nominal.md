...
Dari Tabel \@ref(tab:tbl-analisis-univariat), dapat kita lihat bahwa pada bab-bab sebelumnya, kita hanya menganalisis **satu variabel saja**. Namun, pada bab ini kita akan menganalisis **dua variabel secara bersamaan**.
