...
Pemilihan teknik analisis statistik deskriptif sangat bergantung pada tujuan analisis (apakah melihat pemusatan atau penyebaran) dan tingkat pengukuran variabel yang tersedia. Tabel berikut merangkum berbagai teknik yang telah dipelajari beserta syarat penggunaannya.

| No | Nama Analisis | Tingkat Pengukuran | Makna Singkat Hasil |
|:--:|:---|:---|:---|
| 1 | Frekuensi & Persentase | Nominal, Ordinal, Metrik | Jumlah atau proporsi kemunculan suatu nilai dalam distribusi |
| 2 | Rasio | Nominal, Ordinal, Metrik | Perbandingan relatif jumlah satu kategori terhadap kategori lain |
