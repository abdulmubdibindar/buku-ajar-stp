...
kable(perbandingan_kampus, format = 'html', align = 'c',
...
kable(hasil_perbandingan, format = 'html', align = 'c',
...
kable(data_2023, format = 'html', align = 'c',
...
kable(data_2024, format = 'html', align = 'c',
...
kable(data_kendaraan, format = 'html', align = 'c',
...
detail_kendaraan <- data.frame(
  Jenis = c('Sepeda Motor Pribadi', 'Mobil Pribadi', 'Transportasi Online', 
            'Menumpang (Kendaraan Bermotor)', 'Sepeda', 'Berjalan Kaki'),
  Kategori = c('Bermotor', 'Bermotor', 'Bermotor', 'Bermotor', 
               'Non-Bermotor', 'Non-Bermotor'),
  Jumlah = c(276, 47, 32, 43, 18, 13)
)

kable(detail_kendaraan, format = 'html', align = 'c',
...
kable(data_perubahan, format = 'html', align = 'c',
...
kable(data_pajak, format = 'html', align = 'c',
...
kable(dampak_ekonomi, format = 'html', align = 'c',
...
kable(data_awal, format = 'html', align = 'c',
...
kable(data_outlier, format = 'html', align = 'c',
...
kable(perbandingan, format = 'html', align = 'c',
...
kable(modus_kend, format = 'html', align = 'c',
...
kable(modus_perjalanan, format = 'html', align = 'c',
...
data_fakultas <- data.frame(
  Fakultas = c('Ekonomi dan Bisnis Islam', 'Syariah', 'Ushuluddin dan Studi Agama',
...
kable(data_fakultas, format = 'html', align = 'c',
...
kable(hasil_iqv, format = 'html', align = 'c',
...
kable(stat_rentang, format = 'html', align = 'c',
