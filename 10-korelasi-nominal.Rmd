...
data_univariat <- data.frame(
  Bab = c(
    "\\@ref(bab-3-analisis-statistik-deskriptif)",
...
df_karakteristik_tingkat_pengukuran <- data.frame(
  ...
  `Kekuatan` = c("âœ…", "âœ…", "âœ…", "âœ…"),
  `Arah` = c("âŒ", "âœ…", "âœ…", "âœ…"),
  `Pola` = c("âŒ", "âŒ", "âœ…", "âœ…")
)
...
### Bentuk Asosiasi Sepasang Variabel {#bentuk-asosiasi-sepasang-variabel}
...
#     escape = FALSE) |>
#   kable_styling(bootstrap_options = c("striped", "hover", "responsive"), full_width = FALSE, latex_options = if (knitr::is_latex_output()) "HOLD_position" else c("striped", "hover")) |>
...
df_koefisien <- data.frame(
  ...
  Keterangan = c(
    "Digunakan untuk tabel kontingensi $2 \\times 2$",
...
tbl_eval18_out
  ```
   ...
   a. Tentukan koefisien berbasis $\chi^2$ yang pas digunakan untuk menyatakan korelasi kedua variabel tersebut (phi, Cramerâ€™s V, atau C, bisa lebih dari satu) 
