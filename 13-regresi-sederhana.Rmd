...
### Homoskedastisitas
Syarat homoskedastisitas berarti **besar varians (keragaman sebaran) dari galat model harus senantiasa konstan dan seragam** tanpa memedulikan seberapa besar nilai target prediksinya [@ModernStatR-Home]. Sebaliknya, jika sebaran galatnya tidak merata—misalnya menyempit di awal namun semakin melebar bebas di akhir mirip seperti bentuk corong—maka kondisi ini dinamakan **heteroskedastisitas** [@Hair-Multivariate]. Pelanggaran ini berdampak fatal karena dapat menipu nilai uji signifikansi model sehingga kesimpulan tebakannya seolah meyakinkan padahal menyesatkan.

### Non-Autokorelasi
Asumsi ini mengharuskan supaya galat prediksi pada suatu subjek pengamatan berdiri sendiri dan tidak saling memengaruhi nilai galat di pengamatan lainnya [@Hair-Multivariate]. Kondisi di mana galat saling menular (autokorelasi) umumnya sering terjadi pada **data deret waktu (*time series*)**, karena sebuah nilai di suatu waktu sangat bergantung erat pada nilainya di masa lalu (seperti angka tingkat inflasi bulanan atau suhu harian) [@ewing2020basic]. Namun untungnya, bagi riset yang pengumpulan datanya hanya bergantung pada **data silang tempat (*cross-section*)**—di mana sekelompok banyak data dari subjek berbeda direkam bersamaan secara serentak—peluang pelanggaran autokorelasi ini nyaris mustahil bisa terjadi.
