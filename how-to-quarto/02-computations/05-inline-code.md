---
title: "Inline Code"
source: "https://quarto.org/docs/computations/inline-code.html"
author:
published:
created: 2026-06-09
description:
...
CautionKeep Inline Code Simple
...
Quarto also supports the native syntaxes of Knitr and OJS. Read more below in [Syntax Compatibility](https://quarto.org/docs/computations/inline-code.html#syntax-compatibility).

ImportantInline Code Cannot be Used in YAML
...
The native Knitr inline syntax has a different default behavior for handling [Markdown Output](https://quarto.org/docs/computations/inline-code.html#markdown-output). Specifically, it treats all inline output as *containing markdown*. This means the above example is equivalent to:
