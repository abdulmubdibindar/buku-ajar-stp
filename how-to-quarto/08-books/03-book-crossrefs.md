...
source: "https://quarto.org/docs/books/book-crossrefs.html"
author:
published:
created: 2026-06-09
description:
...
> See [Chapter 1](https://quarto.org/docs/books/book-crossrefs.html#) for additional discussion.
...
> See [Chapter 1.2](https://quarto.org/docs/books/book-crossrefs.html#) for more details on visualizing model diagnostics.
...
> As illustrated in [fig. 3.2](https://quarto.org/docs/books/book-crossrefs.html#), the western states have a much higher incidence of forest fires.
