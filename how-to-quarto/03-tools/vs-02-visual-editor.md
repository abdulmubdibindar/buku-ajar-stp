...
source: "https://quarto.org/docs/tools/vscode/visual-editor.html"
author:
published:
created: 2026-06-09
description:
...
![Positron with a document called `libraries.qmd` open in visual editing mode. The subtitle and list of items are typeset. The visual editing toolbar is visible at the top of the document.](https://quarto.org/docs/tools/images/vscode-visual-editor-dark.png)
...
1. Use the ⇧⌃ F4 keyboard shortcut.
2. Use the context menu from anywhere in a document:
	![The context menu in with the Edit in Visual Mode command highlighted.](https://quarto.org/docs/tools/images/vscode-visual-editor-context-menu.png)
3. Use the **Edit in Visual Mode** and **Edit in Source Mode** commands:
	![The command palette with the Edit in Visual Mode command highlighted.](https://quarto.org/docs/tools/images/vscode-visual-mode-command.png)
4. Use the editor menu:
	![The editor menu with the Edit in Visual Mode command highlighted.](https://quarto.org/docs/tools/images/vscode-visual-mode-menu.png)
...
![](https://quarto.org/docs/tools/images/vscode-visual-editor-default-mode.png)

![](https://quarto.org/docs/tools/images/vscode-visual-editor-default-mode-dark.png)
...
![](https://quarto.org/docs/tools/images/vscode-visual-editor-toolbar.png)

Additional commands are available on the **Format**, **Insert**, and **Table** menus:

| ![The contents of the Format drop down menu.](https://quarto.org/docs/tools/images/vscode-visual-editor-format-menu.png) | ![The contents of the Insert drop down menu.](https://quarto.org/docs/tools/images/vscode-visual-editor-insert-menu.png) | ![The contents of the Table drop down menu.](https://quarto.org/docs/tools/images/vscode-visual-editor-table-menu.png) |
| --- | --- | --- |
...
![](https://quarto.org/docs/tools/images/vscode-visual-editor-options.png)
...
![The 'Insert Citation' dialog. The 'My Library' option is selected. The search bar at the top of the right section is empty, but the search results section is filled with the contents of a Zotero reference manager library. Each of the search result icons has a small 'Z' on the bottom right to indicate that the result comes from a Zotero library.](https://quarto.org/docs/visual-editor/images/visual-editing-citations-zotero-browse.png)

Zotero references will also show up automatically in visual editor completions:

![](https://quarto.org/docs/visual-editor/images/visual-editing-citation-completions.png)
...
If you are running both VS Code and Zotero on your desktop, then no additional configuration is required for connecting to your Zotero library. If however you are using VS Code in a web browser and/or want to access your Zotero library over the web, then a few more steps are required (see the [Zotero Web API](https://quarto.org/docs/tools/vscode/visual-editor.html#zotero-web-api) section for details).
...
![](https://quarto.org/docs/visual-editor/images/visual-editing-vscode-zotero-libraries.png)
...
![The Sync tab of Zotero preferences.](https://quarto.org/docs/visual-editor/images/visual-editing-citations-zotero-sync.png)

Once you’ve configured your library to sync, you need to [create a Zotero API Key](https://www.zotero.org/settings/keys/new):

![The 'New Private Key' section of Zotero. The 'Allow library access' option is selected.](https://quarto.org/docs/visual-editor/images/visual-editing-citations-zotero-keygen.png)

Follow the instructions to create a new access key. Note that if you want to use [Group Libraries](https://quarto.org/docs/tools/vscode/visual-editor.html#group-libraries), you should change the default to provide read-only access to groups (as illustrated above).
...
![](https://quarto.org/docs/visual-editor/images/vscode-zotero-web-config.png)

You’ll then be promoted to enter your Zotero Web API Key:

![](https://quarto.org/docs/visual-editor/images/visual-editing-zotero-vscode-setup.png)
...
Note that if you are within a Quarto [book](https://quarto.org/docs/books/) project then a references `prefix` is applied automatically so no changes to `editor` options are required.
