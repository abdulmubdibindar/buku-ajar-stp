...
| ![A line drawing of an elephant.](https://quarto.org/docs/authoring/images/html-figure.png) |  |  |
| --- | --- | --- |
...
To render the caption instead as alt text you can append a backslash to the line as detailed in [the Pandoc documentation](https://pandoc.org/MANUAL.html#extension-implicit_figures):
...
![An elephant](https://quarto.org/docs/authoring/elephant.png)
...
![A 2x2 grid of pictures of elephants. There are labels underneath each of the pictures. Clockwise from the upper left, the labels say: Surus, Hanno, Lin Wang, and Abdul Abbas.](https://quarto.org/docs/authoring/images/elephant-rows.png)

More complex figure arrangements (e.g. rows with varying column layouts) are possible. See the [Custom Layouts](https://quarto.org/docs/authoring/figures.html#complex-layouts) section below for more details.
...
![Two line plots with captions rendered by Jupyter side-by-side.](https://quarto.org/docs/authoring/images/jupyter-figure-layout-caption.png)
...
![Two scatter plots with captions arranged side-by-side.](https://quarto.org/docs/authoring/images/knitr-figure-layout-caption.png)
