...
[Source: Palmer Penguins (.ipynb)](https://quarto.org/docs/authoring/penguins-preview.html#cell-fig-bill-scatter)
...
![A screenshot of webpage with the title 'penguins.ipynb', a large blue button labelled 'Download Notebook', followed by the notebook contents.](https://quarto.org/docs/authoring/images/notebook-view.png)
...
- Specify cells or blocks in multiple ways, see [Specifying Cells](https://quarto.org/docs/authoring/notebook-embed.html#specifying-cells).
...
- Include the code along with the output by adding an `echo` option to the shortcode, see [Embedding Code](https://quarto.org/docs/authoring/notebook-embed.html#embedding-code).
...
![](https://quarto.org/docs/authoring/notebook-embed_files/figure-html/penguins-qmd-fig-size-scatter-output-1.png)

Figure 2

[Source: Palmer Penguins (.qmd)](https://quarto.org/docs/authoring/penguins-qmd.embed-preview.html#cell-fig-size-scatter)
...
![Screenshot of a code cell in a Jupyter Notebook with the cell tags open in the cell toolbar and displaying the tag 'bill-ratio'.](https://quarto.org/docs/authoring/images/notebook-tag.png)
...
![A density plot of bill ratio by species.](https://quarto.org/docs/authoring/notebook-embed_files/figure-html/penguins-cell-6-output-1.png)
...
![Density plot of bill depth by species.](https://quarto.org/docs/authoring/notebook-embed_files/figure-html/penguins-fig-bill-marginal-output-1.png)
...
![Screenshot of a rendered page with an embedded plot. A link to the Source 'penguins.ipynb' is shown directly below the plot. A similar link is shown below the table of contents under the heading 'Notebooks'.](https://quarto.org/docs/authoring/images/notebook-links.png)
...
As an example, you can view the live previews for the [`penguins.ipynb` notebook](https://quarto.org/docs/authoring/penguins-preview.html) and [`penguins.qmd` notebook](https://quarto.org/docs/authoring/penguins-qmd.embed-preview.html) used in this document.
...
![Screenshot of a rendered page with an embedded plot. A link to the Source 'Plots and Computations' is shown directly below the plot. A similar link is shown below the table of contents under the heading 'Notebooks'.](https://quarto.org/docs/authoring/images/notebook-links-updated.png)
