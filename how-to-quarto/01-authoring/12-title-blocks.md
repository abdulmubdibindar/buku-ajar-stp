...
![Title block with title and description against a blue background up top, and below a section with author, affiliation, and date published.](https://quarto.org/docs/authoring/images/document-title-block-banner.png)
...
![Title block with title and description against an image background up top, and below a section with author, affiliation, and date published.](https://quarto.org/docs/authoring/images/document-title-block-banner-custom.png)
