...
The default HTML annotation style displays annotations in a list below the code block. Clicking on the annotation number in the list highlights the relevant lines in the code. Other [HTML styles](https://quarto.org/docs/authoring/code-annotation.html#html-styles) hide the annotations, revealing them in a tooltip when a user hovers or selects a marker, as illustrated in this example of a Revealjs presentation:

```yaml
format: revealjs
```
<iframe src="https://quarto.org/docs/authoring/code-annotation-example/revealjs.html"></iframe>
...
To add code annotation to a code block, you need to add two things: specially formatted code comments in your code cell, and an ordered list below the code cell with the annotation text. Read more in [Annotation Syntax](https://quarto.org/docs/authoring/code-annotation.html#annotation-syntax).
