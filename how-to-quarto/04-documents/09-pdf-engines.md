...
If you prefer TeX Live, you can find instructions for installing it here: [https://tug.org/texlive/](https://tug.org/texlive/).
...
Engine options can still be set using [`pdf-engine-opts`](https://quarto.org/docs/output-formats/pdf-engine.html#alternate-pdf-engines). For example:
