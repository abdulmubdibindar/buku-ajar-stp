...
![Screenshot of an About page using the trestles template. It has a headshot of the author and links on the left and the body of the about page on the right.](https://quarto.org/docs/websites/images/about-trestles-dark.png)

![Screenshot of an About page using the solana template. It has the author name, links, and body on the left and a rectangular headshot on the right.](https://quarto.org/docs/websites/images/about-solana-dark.png)

![Screenshot of an About page using the marquee template. It has a large image at the top, followed by the author name, body, and links below.](https://quarto.org/docs/websites/images/about-marquee-dark.png)

![Screenshot of an About page using the broadside template. It has the author image on the left and the name, body, and links on the right.](https://quarto.org/docs/websites/images/about-broadside-dark.png)
