...
source: "https://quarto.org/docs/websites/website-blog.html"
author:
published:
created: 2026-06-09
description:
...
![](https://quarto.org/docs/websites/images/positron-create-project-blog-dark.png) ![](https://quarto.org/docs/websites/images/positron-create-project-blog.png)
...
The new blog project will be created and opened within Positron. Click the **Preview** button () to preview the blog:

![](https://quarto.org/docs/websites/images/positron-create-project-render-blog-dark.png) ![](https://quarto.org/docs/websites/images/positron-create-project-render-blog.png)
...
The new blog project will be created and opened within VS Code. Click the **Preview** button (![Preview icon](https://quarto.org/docs/tools/images/vscode-preview-icon.svg)) to preview the blog:
...
The home page is a [listing page](https://quarto.org/docs/websites/website-listings.html) for all of the documents in the `posts` directory:

![Screenshot of a blog listing page with a navbar showing the blog name, About link, GitHub and Bluesky icons, and two blog posts with thumbnail images and categories.](https://quarto.org/docs/websites/images/myblog-dark.png)
...
See the article on [Listing Pages](https://quarto.org/docs/websites/website-listings.html) to learn more about customizing listings, including use a grid layout rather than the default shown above.

## About Page

The `about.qmd` document includes additional information on the blog and its author. For example:

![Screenshot of an about page. It has a large round circle in the top center with an image shown. Below that is a name in large type, with smaller placeholder body text beneath it. There are two buttons at the bottom, one for Bluesky, and one for GitHub.](https://quarto.org/docs/websites/images/about-jolla-dark.png)
...
See the article on [About Pages](https://quarto.org/docs/websites/website-about.html) to learn about the various options available for customizing page output.
...
Draft posts will appear when you preview the site, but will be blank when you render the site and will not appear in listings, navigation, the site map, or site search. You can read more about drafts in [Website Drafts](https://quarto.org/docs/websites/website-drafts.html).
...
In the default blog we include a file (`_metadata.yml`) that establishes [shared metadata](https://quarto.org/docs/projects/quarto-projects.html#shared-metadata) for all documents within the `posts` directory. In this file, we specify that we want `freeze: true` set by default for all posts:
...
See the article on the [`freeze`](https://quarto.org/docs/projects/code-execution.html#freeze) option to learn more about freezing computational output within websites.

## Themes

Blogs can use any of the 25 [Bootswatch](https://bootswatch.com/) themes included with Quarto. You can also [create your own](https://quarto.org/docs/output-formats/html-themes.html#theme-options) themes. The default blog generated by `quarto create project` uses the [cosmo](https://bootswatch.com/cosmo/) theme. Here are links to the available themes along with thumbnails of what the simple default blog looks like under a few of them:
...
Now, when your site is rendered, an RSS feed will also be generated. To learn more, see the article on [RSS Feeds](https://quarto.org/docs/websites/website-listings.html#feeds).

TipIncluding an RSS Link on the Navbar
...
The article on [Publishing Websites](https://quarto.org/docs/publishing/) describes in more detail how to publish to the following services:
...
![Screenshot of blog with a Subscribe section in the top of the right-hand section of the bofy. There is an input field marked 'email address' and a button below it labelled 'Subscribe'.](https://quarto.org/docs/websites/images/myblog-subscribe.png)